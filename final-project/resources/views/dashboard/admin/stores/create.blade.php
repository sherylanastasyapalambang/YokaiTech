    ...
    <main class="p-1 md:ml-64 h-auto pt-5">
        <section>
            <div class="py-8 px-4 mt-5 mx-auto max-w-2xl lg:py-16">
                <form action="{{ route('dashboard.admin.stores.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <select name="seller_id" id="seller_id" 
                                ...
                                <option value="" {{ old('seller_id') == '' ? 'selected' : '' }}>Select seller</option>
                    ...
                    <div class="flex space-x-4 mt-1 ">
                        ...
                        <a href="{{ route('dashboard.admin.stores.index') }}"
