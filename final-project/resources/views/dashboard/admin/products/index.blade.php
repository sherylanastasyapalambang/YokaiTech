                ...
                <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
                        <div class="w-full md:w-2/3">
                            <form method="GET" class="flex flex-col lg:flex-row lg:items-center space-y-3 lg:space-y-0 lg:space-x-4">
                                ...
                                <div class="w-full lg:w-32">
                                    ...
                                    <select id="store" name="store_id" onchange="this.form.submit()"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        {{-- <div class="w-full md:w-auto flex justify-end">
                            <a href="{{ route('dashboard.admin.products.create') }}"
                              ...
                              @foreach ($products as $product)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <a href="{{ route('dashboard.admin.products.show', $product->slug) }}" class="hover:underline">{{ $product->name }}</a>
                                    </th>
                                    ...
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <a href="{{ route('dashboard.admin.stores.show', $product->Store->slug) }}" class="hover:underline">{{ $product->store->name }}</a>
                                    </td>
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="product-dropdown-{{ $product->id }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a href="{{ route('dashboard.admin.stores.show', $product->Store->slug) }}"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                                </li>
                                                {{-- <li>
                                                    <a href="{{ route('dashboard.admin.products.edit', $product->slug) }}"
