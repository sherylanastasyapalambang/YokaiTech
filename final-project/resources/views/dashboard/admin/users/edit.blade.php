                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="phone" id="phone"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                value="{{ $user->phone }}" placeholder="08xxxxxxxxxx" required="">
                        </div>
                        <div class="w-full">
                            <label for="password"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="address" id="address"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                value="{{ $user->address }}" placeholder="st. michidoko, yokaimachi, Japan" required="">
                        </div>
                        <div class="w-full">
                            <label for="role" class="block mb-2 text-sm font-medium text-gray-900">Select role</label>
                            <select disabled name="role" id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
