    ...
    <main class="p-1 md:ml-64 h-auto pt-5">
        <section>
            <div class="py-8 px-4 mt-5 mx-auto max-w-2xl lg:py-16">
                <form action="{{ route('dashboard.seller.stores.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name') }}" placeholder="Fill the store's name" required="">
                        </div>  

                        <div class="w-full">
                            <div class="flex items-center justify-center w-full">
                                <img id="imagePreview" 
                                     src="{{ asset('storage/stores/default-storeImage.jpg') }}" 
                                     alt="store Image" 
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" id="description" value="{{ old('description') }}" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Your description here"></textarea>
                        </div>
                    </div>
