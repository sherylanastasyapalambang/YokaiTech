    ...
    <main class="h-auto">
        <section class="bg-white py-8 antialiased md:py-8">
            <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
              <h2 class="mb-4 text-xl font-semibold text-gray-900 sm:text-2xl md:mb-6">Edit Detail</h2>
                ...
                <div class="py-4 md:py-8">
                    <form action="{{ route('dashboard.buyer.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
