<x-app-layout>
            ...
            <div id="div-kecil1" class="rounded-lg h-32 md:h-64">
                <figure class="relative w-full h-full transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0" style="height: 100%;">
                    ...
                    <figcaption class="absolute px-4 text-lg text-black bottom-6">
                      <p class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-slate-100 from-slate-400 drop-shadow-lg">
                        {{ $product->name }}
                      </p>
  ...
  <div class="mx-auto grid max-w-screen-xl rounded-lg bg-slate-950 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-3 xl:gap-16 mb-4">
    ...
    <div class="me-auto place-self-center lg:col-span-7">
      ...
      <a href="{{ route('products.index') }}" class="inline-flex items-center justify-center rounded-lg bg-blue-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"> Order now </a>
    </div>
  </div>
